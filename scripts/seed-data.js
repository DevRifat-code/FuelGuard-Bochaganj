...
const { getFirestore, collection, addDoc, Timestamp } = require('firebase-admin/firestore')
...
async function seedData() {
  try {
    ...
    // 4. Create sample vehicle for owner
    ...
    console.log('Created sample vehicle:', vehicleRef.id)
    ...
    console.log('2. manager_bakultala / manager123 — Manager (Station: Bakultala)')
